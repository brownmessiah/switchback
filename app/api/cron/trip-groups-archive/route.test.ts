 ...
 * service (RUN_CRON_ROUTES=true), where the existing CRON_SECRET check applies.
 */
...
vi.mock('@/lib/trip-groups/group-transitions', () => ({ sweepAutoArchive: vi.fn() }))

describe('POST /api/cron/trip-groups-archive (env gate)', () => {
  beforeEach(() => {
